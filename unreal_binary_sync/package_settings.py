...
def main():
    ...
    dialog.add_info("Select whether your Unreal Engine is built from source code or installed via the<br>Epic Games Launcher.")
    ...
    dialog.add_info("Only applicable when using S3 Cloud Storage. Provide the access credentials to access<br>your S3 bucket where the binaries are stored.")
