...
def create_dialog():
    ...
    dialog.add_info(
        "Choose an S3 compatible server such as AWS, Wasabi or choose <br>a Backblaze B2 server. Take a look at this <a href='https://docs.anchorpoint.app/docs/asset-management/utilities/cloud-drive/'>tutorial</a>."
    )
    ...
    dialog.add_button(
        ...
        primary=False,
    ).add_button("Clear Configuration", callback=clear_config, primary=False)
    dialog.add_info(
