...
def create_dialog():
    ...
    dialog.add_info("Choose an S3 compatible server such as AWS, Wasabi or choose <br>a Backblaze B2 server. Take a look at this <a href='https://docs.anchorpoint.app/docs/4-Collaboration/3-Cloud-Drive/'>tutorial</a>.")
