...
if __name__ == "__main__":
    ...
    dialog.add_info("Creating a Git repository will create a new project in Anchorpoint. <br> Learn more about <a href=\"https://docs.anchorpoint.app/docs/4-Collaboration/5-Workflow-Git/\">Git.</a>")
