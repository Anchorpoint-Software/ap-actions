...
if __name__ == "__main__":
    ...
    dialog.add_info("Creating a Git repository will create a new project in Anchorpoint. <br> Learn more about <a href=\"https://docs.anchorpoint.app/docs/3-work-in-a-team/git/1-Git-basics/\">Git.</a>")
