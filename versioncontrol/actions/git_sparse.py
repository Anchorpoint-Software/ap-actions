...
def on_download_remote_folder(relative_folder_path: str, ctx):
    try:
        ...
        progress = ap.Progress("Downloading folder", show_loading_screen=True, cancelable=False)
...
def on_unload_remote_folder(relative_folder_path: str, ctx):
    try:
        ...
        progress = ap.Progress("Unloading folder", show_loading_screen=True, cancelable=False)
