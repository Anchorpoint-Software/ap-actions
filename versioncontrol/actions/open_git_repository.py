...
def on_folder_opened(ctx: ap.Context):
    ...
    dialog.add_info("Opening a Git repository as a project in Anchorpoint enables <br> certain actions in the project timeline. Learn more about <a href=\"https://docs.anchorpoint.app/docs/3-work-in-a-team/git/1-Git-basics/\">Git.</a>")
